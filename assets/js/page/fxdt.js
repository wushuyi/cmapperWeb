        ...
        execute: function () {
            FxdtPage = (function (_BasePage) {
                function FxdtPage() {
                    ...
                    _classCallCheck(this, FxdtPage);

                    if (arg[0] === false) {
                        return false;
                    }
                    _get(Object.getPrototypeOf(FxdtPage.prototype), 'constructor', this).call(this, false);
                    this.initialize.apply(this, arg);
                }

                _inherits(FxdtPage, _BasePage);

                _createClass(FxdtPage, [{
                    key: 'initialize',
                    value: function initialize() {
                        _get(Object.getPrototypeOf(FxdtPage.prototype), 'initialize', this).call(this);
                        var $el = {};
                        this.$el = $el;
                        var iscrolls = {};
                        ...
                        $el.page = $('#page_fxdt');
                        _get(Object.getPrototypeOf(FxdtPage.prototype), 'startPage', this).call(this);
                    ...
                    value: function destroy() {
                        ...
                        _get(Object.getPrototypeOf(FxdtPage.prototype), 'endPage', this).call(this, function () {
